...
public class TweetsSearchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    private void initialize()
    {
        ...
        // selection of timer
        NavigationView navigationView = (NavigationView) findViewById(R.id.navigation_view_for_refresh_rate);
        navigationView.setNavigationItemSelectedListener(this);

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_view_tweets);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
//        recyclerView.setAdapter(new TweetsRecyclerAdapter(this, R.layout.tweet_card_view, BR.tweet));
